...
const MagicBento = ({
  ...
  const defaultCards = [
    {
      title: "Technical",
      description: "Master coding challenges and algorithms",
      label: "Code",
    ...
    {
      title: "Creatives",
      description: "Explore UI/UX and design thinking",
      label: "Design",
    ...
    {
      title: "Corporate",
      description: "Develop professional skills and network",
      label: "Grow",
          ...
          return (
            ...
            >
              <div 
                ...
                style={{
                  backgroundColor: card.overlayColor || 'rgba(0, 0, 0, 0.6)',
